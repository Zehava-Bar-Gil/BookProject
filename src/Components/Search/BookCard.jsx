...
import { Card, CardTitle, CardImg, CardBody, Button, Modal } from 'reactstrap';
 ...
 const BookCard =({ 
    ...
    return <Card style={ { width: '233px' } } className='m-auto'>
            <CardImg top style={ { width: '100%', height: '233px'} } 
            src={thumbnail} 
            alt={title}
            />
            <CardBody>
            ...
            <Modal isOpen={modal} toggle={toggle}>
                <div className="modal-header d-flex-content-center">
                ...
                <div className="d-flex justify-content-between ml-3">
                   ...
                   <div className="modal-footer">
                       <div className="left-silde">
                           ...
                           color='default' 
                           target='blank' 
                           rel='nonpener noreferrer'>Preview Link</a>
                       </div>
                       <div className="divider"></div>
                       <div className="right-silde">
                           <a href={infoLink} className='btn-link' 
                           color='default' 
                           target='blank' 
                           rel='nonpener noreferrer'>Info Link</a>
                        </div>
                   </div>
            </Modal>
        </Card>;
